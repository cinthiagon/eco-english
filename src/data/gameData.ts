...
export const QUIZ_QUESTIONS: QuizQuestion[] = [
  { id: 'q1', question: 'Which light bulb uses LESS energy?', options: ['LED bulb', 'Incandescent bulb', 'Candle', 'Torch'], correctIndex: 0, explanation: 'LED bulbs use up to 75% less energy than traditional incandescent bulbs!', emoji: '💡', difficulty: 'easy' },
  { id: 'q2', question: 'How can you save water while brushing your teeth?', options: ['Take a long shower', 'Turn off the tap while brushing', 'Water your plants at noon', 'Leave the tap running'], correctIndex: 1, explanation: 'Turning off the tap while brushing can save up to 8 liters of water per minute!', emoji: '💧', difficulty: 'easy' },
  { id: 'q3', question: 'What is the MOST eco-friendly way to get to school?', options: ['By car', 'By airplane', 'Walking or cycling', 'By motorcycle'], correctIndex: 2, explanation: 'Walking or cycling produces zero emissions and also keeps you fit and healthy!', emoji: '🚲', difficulty: 'easy' },
  { id: 'q4', question: 'What does "renewable energy" mean?', options: ['Energy that will eventually run out', 'Energy from the sun, wind, and water', 'Energy produced by burning coal', 'Energy produced by burning wood'], correctIndex: 1, explanation: 'Renewable energy comes from natural sources that are constantly replenished, like sunlight and wind!', emoji: '☀️', difficulty: 'medium' },
  { id: 'q5', question: 'Which gas is the main cause of climate change?', options: ['Oxygen', 'Carbon dioxide (CO2)', 'Nitrogen', 'Hydrogen'], correctIndex: 1, explanation: 'Too much CO2 in the atmosphere traps the sun\'s heat, which slowly warms our planet!', emoji: '🌍', difficulty: 'medium' },
  { id: 'q6', question: 'What is composting?', options: ['Throwing food scraps in the trash', 'Turning food scraps into natural fertilizer', 'Burning organic waste', 'Recycling plastic bottles'], correctIndex: 1, explanation: 'Composting turns food scraps and garden waste into rich soil that helps plants grow!', emoji: '🌿', difficulty: 'medium' },
  ...
  { id: 'q9', question: 'Which of these is NOT a source of clean energy?', options: ['Solar power', 'Wind power', 'Burning coal', 'Hydroelectric power'], correctIndex: 2, explanation: 'Burning coal releases large amounts of CO2 and toxic pollutants — it is a dirty energy source!', emoji: '⚡', difficulty: 'hard' },
  { id: 'q10', question: 'What do the 3 Rs of sustainability stand for?', options: ['Run, Rest, Relax', 'Reduce, Reuse, Recycle', 'Read, Write, Calculate', 'Red, Round, Right'], correctIndex: 1, explanation: 'Reduce, Reuse, Recycle — three simple actions that together make a huge difference for our planet!', emoji: '♻️', difficulty: 'easy' },
];
